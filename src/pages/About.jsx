  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black pt-24 pb-12 px-6 transition-colors duration-300">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white dark:bg-black rounded-xl shadow-lg p-8 mb-8 transition-colors duration-300">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
            ...
            including academics, facilities, services, finance, fees, security, and more.
          </p>

          <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Our Values</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-50 dark:bg-black p-4 rounded-lg transition-colors duration-300 border border-gray-200 dark:border-gray-800">
            ...
            <div className="bg-gray-50 dark:bg-black p-4 rounded-lg transition-colors duration-300 border border-gray-200 dark:border-gray-800">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Accountability</h3>
