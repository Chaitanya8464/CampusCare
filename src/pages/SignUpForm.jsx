...
export default function SignUpForm() {
  ...
  const socialButtons = [
    { icon: github, name: "GitHub", onClick: () => console.log("GitHub signup") },
    { icon: google, name: "Google", onClick: () => console.log("Google signup") },
    { icon: facebook, name: "Facebook", onClick: () => console.log("Facebook signup") },
  ];
    ...
    <div className="min-h-screen w-full flex bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center p-12">
        ...
        >
          ...
          <h1 className="text-5xl font-bold mb-4 text-gray-800 dark:text-white">Join CampusCare Today!</h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Join CampusCare today</p>
          </div>
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">Or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSignUp}>
            ...
            <div className="relative mb-3 group">
              ...
              <input
                ...
                className={`w-full bg-gray-50 dark:bg-gray-700 border rounded-xl pl-10 pr-10 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all dark:text-white ${
            ...
            {/* Role Selection */}
            <div className="mb-4">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Account Type:</p>
